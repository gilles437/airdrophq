      ...
      <Row>
        ...
        <Col lg={9}>
          ...
          <div className="card panel mt-lg mb-xs">
            {/* eslint-disable */}
            <div
              className="card-header panel-header bg-light"
              role="button"
              onClick={() => {
            ...
            <Collapse className="panel-body" isOpen={this.state.accordion[0]}>
              <p>
                ...
                navigation. Using the collapse plugin, we built a simple accordion by extending the
                panel component.
              </p>
            </Collapse>
          </div>
          ...
          <div className="card panel mb-lg">
            ...
            <Collapse className="panel-body" isOpen={this.state.accordion[2]}>
              <p>
                <span className="fw-semi-bold">Light Blue</span> - is a next generation admin
                template based on the latest Metro design. There are few reasons we want to tell
                you, why we have created it: We didn't like the darkness of most of admin templates,
                so we created this light one. We didn't like the high contrast of most of admin
                templates, so we created this unobtrusive one. We searched for a solution of how to
                make widgets look like real widgets, so we decided that deep background - is what
