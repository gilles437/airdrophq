...
const PromocodesTable = () => {
  ...
  const modalOpen = useTypedSelector((store) => store.promocodes.list.modalOpen);
  const idToDelete = useTypedSelector((store) => store.promocodes.list.idToDelete);
  ...
  return (
    <div>
      <Widget title={<h4>Promocodes</h4>} collapse close>
