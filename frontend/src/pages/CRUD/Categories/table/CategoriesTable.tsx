...
const CategoriesTable = () => {
  const [filters, setFilters] = React.useState<any[]>([{ label: 'Title', title: 'title' }]);
  ...
  const modalOpen = useTypedSelector((store) => store.categories.list.modalOpen);
  const idToDelete = useTypedSelector((store) => store.categories.list.idToDelete);
